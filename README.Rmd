...
# Description  
The goal of the package hw3mklinreg is to run a linear regression comparrable to what is found with the lm() function.  mk_lm can run for simple and multiple linear regression.
